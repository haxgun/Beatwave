...
<!--          <img src="spotify.svg"  alt="Spotify Logo" width="250px">-->
        ...
        <p class="subdescription">
          Milady displays on your Stream information about the current track,
          the artist and the cover of the track playing on
          <span style="white-space: nowrap;"><span style="display: inline-flex; position: relative; top: 6px;">
